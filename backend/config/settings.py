...
SECRET_KEY = 'django-insecure-qir83vjtypw@wv9glgxy$7m@d76pw@ce+=wj)fl&%0hurpuh0g'
...
SIMPLE_JWT = {
    ...
    'VERIFYING_KEY': None,        # Used for asymmetric algorithms like RS256
    'AUDIENCE': None,
    'ISSUER': None,
...
# Cookies (names are used below in views)
